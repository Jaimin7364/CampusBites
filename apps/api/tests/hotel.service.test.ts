...
const repository = vi.hoisted(() => ({ findBySellerId: vi.fn(), findById: vi.fn(), create: vi.fn(), update: vi.fn(), transition: vi.fn(), remove: vi.fn(), list: vi.fn() }));
...
import { approveHotel, createSellerHotel, deleteHotel, resubmitSellerHotel, setFeatured, updateSellerHotel } from '../src/services/hotel.service.js';
